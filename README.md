![alt text](assets/imgs/gentree-s1.png)
# What's Gentree?
...
# Why Gentree?
While [**genRojoTree**](github.com/leifstout/genRojoTree) offers similar services, a lot of developers report being confused with it, therefore **Gentree** has a simpler CLI set-up, which is easy to initialize with 2 commands, offering a way easier learning curve.
...
# Tools Needed
To get started you'll first need to install [**Git**](https://git-scm.com/install/) & [**NPM/NodeJS**](https://nodejs.org/en/download), for further assistance in installing **Gentree** please check [**Gentree's Installation Guide**](INSTALLATION_GUIDE.md).
